      ...
      <div className="relative z-10 flex h-full items-center px-4 sm:px-6 lg:px-12">
        ...
        <div className="w-full max-w-xl text-left">
          ...
          <motion.h1
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="mb-6 text-4xl font-extrabold tracking-tight text-[#1a237e] sm:text-6xl leading-tight"
          >
          ...
          <motion.form
            ...
            transition={{ duration: 0.6, delay: 0.4 }}
            onSubmit={handleSearch}
            className="flex flex-col items-start sm:flex-row sm:gap-4 gap-6"
          >
            <div className="flex-1 w-full sm:w-auto">
              <input
                type="text"
                placeholder="Search Here..."
                className="w-full rounded-lg border border-gray-300 bg-white px-6 py-4 text-lg shadow-md focus:border-blue-500 focus:ring-2 focus:ring-blue-500"
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
              />
            </div>
            <button
              type="submit"
              className="flex items-center justify-center gap-2 rounded-lg bg-[#ffa726] px-10 py-4 font-semibold text-white shadow-md transition hover:bg-[#ff9800] focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
            >
